...
require (
	...
	github.com/grafana/alerting v0.0.0-20260227181651-5106b6285f2d
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20260310101443-49cb62adbe54
